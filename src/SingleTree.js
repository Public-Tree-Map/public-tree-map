  ...
  return (
    <div className="singleTreeView">
      <div className="basicInfo">
        ...
        <div className="propertyDetails">{props.tree.speciesName}</div>
      ...
      <div className="locationInfo">
        ...
        <div className="propertyDetails">{props.tree.location.treeId}</div>
        <img
      ...
      <div className="sizeInfo">
        ...
        <div className="propertyDetails">{props.tree.size.heightRange}</div>
      ...
      <div className="valueInfo">
        ...
        <div className="propertyDetails">
          {props.tree.treeValue.shedability}
        </div>
      </div>
      ...
      <div className="originInfo">
        ...
        <div className="propertyDetails">{props.tree.origin.origin}</div>
        ...
        <div className="propertyDetails">
          {props.tree.origin.naturalHabitat}
        </div>
        <div className="propertyLabel">Fun Fact:</div>
        <div className="propertyDetails">{props.tree.origin.funFact}</div>
      </div>
    </div>
  );
};
